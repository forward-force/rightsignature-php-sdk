...
namespace ForwardForce\RightSignature\Tests\Entities;
...
class PropertyTest extends TestCase
{
    ...
    public function testFetch()
    {
        ...
        try {
            ...
            $correct = Document::API_VERSION . '/property/?token=123456&city=Rochester&street_address=151+Battle+Green+Dr&state=NY&zip_code=14624';
